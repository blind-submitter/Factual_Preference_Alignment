...
```bash
python src/project/data_construction/stage_1_extraction/dataextraction_train.py
python src/project/data_construction/stage_2_conversion/dataconversion_train.py
python src/project/data_construction/stage_3_factuality/dataset_train.py
python src/project/data_construction/stage_4_transformation/data_transform_train.py
python src/project/data_construction/stage_5_syntheticdata/data_synthetic_train.py
python src/project/data_construction/stage_6_merging/merge_train.py
python src/project/data_construction/stage_7_balancing/balance_train.py
python src/project/data_construction/stage_8_flipping/data_flipped_train.py
```
