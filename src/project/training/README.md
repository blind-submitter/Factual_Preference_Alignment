...
```
src/projecy/config/config.yaml
```
...
```yaml
paths:
  train: "src/project/training/data/original/train_finallast.jsonl"
  eval:  "src/project/training/data/original/eval_final.jsonl"
  output_root: "src/project/training/data/original/Models"
```
...
```
src/project/training/run_dpo_training.py
```

### Output directory structure

```
src/project/training/data/original/Models/<short>_OriginalDPO/
```
...
```yaml
paths:
  train_file: "src/project/training/data/factual/train_final_flipped.jsonl"
  eval_file:  "src/project/training/data/factual/eval_final_flipped.jsonl"
  output_root: "src/project/training/data/factual/Models"
```
...
```bash
python -m project.training.run_dpo_training --model "google/gemma-2-9b-it"
```
...
```bash
python -m project.training.run_factual_training     --model_id "google/gemma-2-9b-it"     --short "gemma2-9b"     --delta 10
```

Saves to:

```
src/project/training/data/factual/Models/<short>_delta10/
```
